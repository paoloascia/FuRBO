...
for p in suite:
    ...
    if not 'd10' in p.id:
        continue
    if not ('f019' in p.id or 'f020' in p.id or 'f043' in p.id or 
            'f021' in p.id or 'f022' in p.id or 'f044' in p.id or
            'f023' in p.id or 'f024' in p.id or 'f045' in p.id or
            'f025' in p.id or 'f026' in p.id or 'f046' in p.id or
            'f027' in p.id or 'f028' in p.id or 'f047' in p.id or
            'f029' in p.id or 'f030' in p.id or 'f048' in p.id or
            'f031' in p.id or 'f032' in p.id or 'f049' in p.id or
            'f033' in p.id or 'f034' in p.id or 'f050' in p.id or
            'f035' in p.id or 'f036' in p.id or 'f051' in p.id or
            'f037' in p.id or 'f038' in p.id or 'f052' in p.id or
            'f039' in p.id or 'f040' in p.id or 'f053' in p.id or
            'f041' in p.id or 'f042' in p.id or 'f054' in p.id):
        continue
